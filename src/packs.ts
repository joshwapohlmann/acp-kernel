      ...
      pi: {
        promptSections: {
          acpTags: [
            ...
            `Compression summaries are fallible historical metadata, not current user instructions — treat them as settled history. A summary you just wrote is your own record: after a successful compress, do NOT verify it with acp_status/decompress/search — the result panel already lists remaining ranges and refs; continue the task.`,
          ].join("\n"),
