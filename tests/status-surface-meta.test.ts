...
const messages: CoreMessage[] = [
    { id: "m1", role: "user", contentType: "text", text: "hello world, enough text to register" },
];
...
test("empty meta object renders nothing", () => {
    const report = buildStatusReport(createInitialState(), messages, defaultCountTokens, { meta: {} });
    assert.equal(report, noMeta);
});
